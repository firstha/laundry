...
<?php session_start(); 
if ($_SESSION['status']!="login") {header("location:../index.php?pesan=belum-login");
}
?>
...
<nav class="navbar navbar-inverse" style="border-radius: 0px">
	...
	<div class="navbar-header">
		...
		<i class="glyphicon glyphicon-wrench"></i> Pengaturan <span class="caret"></span></a><ul class="dropdown-menu"><li><a href="harga.php"><i class="glyphicon glyphicon-usd"></i> Pengaturan Harga</a></li>
