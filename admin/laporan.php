...
<div class="panel-heading">  
    ...
    <div class="panel-body">  
        ...
        if(isset($_GET['tgl_dari']) && isset($_GET['tgl_sampai'])){  
            ...
            <div class="panel">
            <div class="panel-heading">
            <h4>Data Laporan Laundry <b> <?php echo $dari; ?> </b> sampai <b> <?php echo $sampai; ?> </b></h4>  
            </div>
                ...
                while($d = mysqli_fetch_array($data)){  
                    ...
                    <tr>  
                        ...
                        <td>
                            ...
                            if($d['transaksi_status']=="1"){ echo "<div class='label label-info'>DICUCI</div>";

                            }else 

                            if($d['transaksi_status']=="2"){ echo "<div class='label label-success'>SELESAI</div>";
                             } 
                             ?>
                        </td> 
                    </tr>  
